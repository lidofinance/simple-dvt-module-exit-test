...
echo "run anvil in separate terminal with command (restart if it has been started before):"
echo "anvil --fork-url https://mainnet.infura.io/v3/\$INFURA_KEY"

read -p "running (y/n)? " CONT
if [ "$CONT" = "y" ]; then
    echo
else
    echo "exiting"
...
echo "run ejector and mock server in separate terminal with command:"
echo "export CL_NODE_URL=\$CL_NODE_URL && docker-compose -f docker-compose.yml up"
...
keys_count=1
pubkey=0x96894385d430166da55c24f8fa7e663ef179a94285939c5f733ab37003908ae58fce5848cc58c270b9544739b9b6b904
signature=0xa5ab069ec37152fe76eea804fc99e3f3241a000fc352038c7cad0295dd9d259c5b90b267d760f0cf54929c1164a7b0b51276b88abd06f2104a124419b57793274bca131dde38126455bf380e43c6b425a22335bcaefd28583457e414f97a6f3e
operator_id=0
...
requests_count=1
data_format=1
validator_index=1000000 # same as in mock_validator.json
...
cast rpc anvil_mine 64 12 > /dev/null
